...
const Modal = (props) => {
    ...
    const constructor = (() => {
        ...
        title.setAttribute('style', 'border: 2px solid black; background: var(--tigers-eye); font-weight: var(--semibold); font-size: 32px; color: var(--cornsilk)');
        description.setAttribute('style', 'border: 2px solid black; background: var(--tigers-eye); font-size: 16px; color: var(--cornsilk); height: 10%');
        dateDiv.setAttribute('style', 'display: flex; align-items: center; gap: 10px');
        dateImg.setAttribute('style', 'width: 25px');
        date.setAttribute('style', 'border: 2px solid black; background: var(--tigers-eye); font-size: 16px; color: var(--cornsilk); font-size: 20px');
        noteDiv.setAttribute('style', 'display: flex; flex-direction: column; gap: 10px; height: 45%');
        ...
        note.setAttribute('style', 'border: 2px solid black; background: var(--tigers-eye); font-size: 16px; color: var(--cornsilk); font-size: 20px; height: 100%');
        buttonsSpacer.setAttribute('style', 'display: flex; align-items: end; width: 100%; height: 100%');
        buttonsDiv.setAttribute('style', 'display: flex; gap: 25px; width: 100%');
        exitButton.setAttribute('style', 'width: 50%; height: 30px; border-radius: 5px; background: var(--earth-yellow); border: 0;  color: var(--cornsilk)');
        deleteButton.setAttribute('style', 'width: 50%; height: 30px; border-radius: 5px; background: var(--earth-yellow); border: 0;  color: var(--cornsilk)');
